...
// Send a GET request to /courses to READ a list of courses this also includes the user that owns each course
...
//Sends POST request to /courses to CREATE a new course
router.post('/', [
  // Validations
  check('title')
  ...
  // If there are validation errors use an array `map()` method to get a list of error messages.
  if (!errors.isEmpty()) {
